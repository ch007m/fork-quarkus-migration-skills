# Spring Boot → Quarkus Dependency Map

## Core

| Spring Boot | Quarkus (Full Migration) | Quarkus (Compatibility) |
|-------------|--------------------------|------------------------|
| `spring-boot-starter-web` | `quarkus-rest` (formerly RESTEasy Reactive) | `quarkus-spring-web` |
...
| `spring-boot-starter-quartz` | `quarkus-quartz` or `quarkus-scheduler` | — |
